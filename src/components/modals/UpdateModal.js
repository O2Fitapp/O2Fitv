...
const UpdateModal = ({ item, lang, crossPressed }) => {
    return (
        <TouchableOpacity
            ...
            />
            <View style={{ backgroundColor: defaultTheme.white, width: dimensions.WINDOW_WIDTH * 0.9, borderRadius: moderateScale(10), alignItems: "center", justifyContent: "center", padding: moderateScale(5), borderWidth: 1, borderColor: defaultTheme.green, top: moderateScale(-20) }}>
                <Text style={[styles.headerText, { fontFamily: lang.font }]}>
                    {lang.update}
                </Text>
                <AnimatedLottieView
                ...
                <Text style={[styles.descriptionText, { fontFamily: lang.font }]}>
