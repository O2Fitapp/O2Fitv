import { View, Text, StyleSheet, Image, Animated, Pressable, Easing, Alert, TouchableOpacity, I18nManager } from 'react-native'
...
const OutPlusBtn = ({ lang, navigation, profile, selectedDate }) => {
    ...
    const rightCol = I18nManager.isRTL ? -dimensions.WINDOW_WIDTH * 0.1 : dimensions.WINDOW_WIDTH * 0.1
    const middleCol = I18nManager.isRTL ? -dimensions.WINDOW_WIDTH * 0.4 : dimensions.WINDOW_WIDTH * 0.4
    const leftCol = I18nManager.isRTL ? -dimensions.WINDOW_WIDTH * 0.7 : dimensions.WINDOW_WIDTH * 0.7

    const plusItems = [
        { id: 1, name: lang.dinner, translateX: leftCol, translateY: firstRowY, icon: isFasting ? <Dinners width={40} height={30} /> : <Dinner width={30} height={30} />, onPressCard: isFasting ? goToDinnerRamadan : goToDinner },
        { id: 2, name: isFasting ? lang.sahari : lang.breakfast, translateX: rightCol, translateY: firstRowY, icon: isFasting ? <Sahari width={40} height={30} /> : <Breakfast width={40} height={30} />, onPressCard: isFasting ? goToSahari : goToBreakfast },
        { id: 3, name: isFasting ? lang.eftar : lang.lunch, translateX: middleCol, translateY: firstRowY, icon: isFasting ? <Eftar width={40} height={30} /> : <Lunch width={40} height={30} />, onPressCard: isFasting ? goToEftar : goToLunch },
        { id: 4, name: lang.snack, translateX: rightCol, translateY: secondRowY, icon: isFasting ? <Snacks width={40} height={30} /> : <Snack width={40} height={30} />, onPressCard: isFasting ? goToSnackRamadan : goToSnack },
        { id: 5, name: lang.step, translateX: rightCol, translateY: thirdRowY, icon: <Shoe width={50} height={30} />, onPressCard: goToStep },
        { id: 6, name: lang.coockingPersonalTitle, translateX: middleCol, translateY: secondRowY, icon: <Foodmaker width={30} height={30} />, onPressCard: goToFoodMaker },
        { id: 7, name: lang.weight, translateX: leftCol, translateY: thirdRowY, icon: <Scale width={30} height={30} />, onPressCard: goToWeight },
        { id: 8, name: lang.water, translateX: middleCol, translateY: thirdRowY, icon: <Glass width={30} height={30} />, onPressCard: goToWatert },
        { id: 9, name: lang.timeOfSleep, translateX: middleCol, translateY: FourthRowY, icon: <Sleep width={40} height={30} />, onPressCard: goToSleep },
        { id: 9, name: lang.notesTitle, translateX: rightCol, translateY: FourthRowY, icon: <Note width={30} height={30} />, onPressCard: goToNote },
        { id: 9, name: lang.plusExercise, translateX: leftCol, translateY: secondRowY, icon: <Activity width={30} height={30} />, onPressCard: goToActivity },
        { id: 9, name: lang.EditLimbBody, translateX: leftCol, translateY: FourthRowY, icon: <Body width={40} height={30} />, onPressCard: goToBody },
    ]
