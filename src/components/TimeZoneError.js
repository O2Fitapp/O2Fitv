...
export default function TimeZoneError(props) {
    ...
    return (
        <TouchableOpacity
            ...
            style={{ position: "absolute", width: dimensions.WINDOW_WIDTH, height: dimensions.WINDOW_HEIGTH, alignItems: "center", justifyContent: "center",backgroundColor:"rgba(0,0,0,0.6)" }}>
            {/* <BlurView
                style={{
                    position: 'absolute',
                    top: 0,
