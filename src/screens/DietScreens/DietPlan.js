...
const DietPlan = (props) => {
    ...
    const [changePackageLoading, setChangePackageLoading] = useState(false)
    ...
    useEffect(() => {
        ...
        if (diet[selectedDate]) {
            console.log(diet[selectedDate][0]);
            ...
            dispatch(setDietMeal(randomPack))
    ...
    useEffect(() => {
        ...
        if (diet[selectedDate] &&
            diet[selectedDate]['0'].isAte &&
            diet[selectedDate]['1'].isAte &&
            diet[selectedDate]['2'].isAte &&
            diet[selectedDate]['3'].isAte &&
            diet[selectedDate]['4'].isAte &&
            diet[selectedDate]['5'].isAte&&
            disableAddBtn==false
        ) {
                                        ...
                                        diet.cheetDays.indexOf(selectedDate) !== -1 ?
                                            ...
                                            <>
                                                <DietPlanRow
                                                    ...
                                                    selectedDate={selectedDate}
                                                    mealDB={mealDB}
                                                    changePackageLoading={changePackageLoading}
                                                    onChangepackage={(e) => {
                                                        setChangePackageLoading(true)
                                                        setTimeout(() => {
