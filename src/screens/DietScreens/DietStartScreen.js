...
import { View, Text, Image, StyleSheet, ScrollView, Animated, FlatList, TouchableOpacity, TouchableWithoutFeedback, SafeAreaView, Alert, ActivityIndicator, BackHandler } from 'react-native'
        ...
        <>
            ...
            <View style={{ backgroundColor: defaultTheme.primaryColor }}>
                <FastImage
                    ...
                    style={{ borderTopRightRadius: 30, borderTopLeftRadius: 30, width: "100%", height: moderateScale(180) }}
                    onLoadEnd={() => {
                        setLoading(false)
                    }}
                    resizeMode='cover'
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <Text style={[styles.text, { fontFamily: lang.titleFont, }]}>
                    {dietCategory ? dietCategory.name[lang.langName] : lang.whatIsDiet}
                </Text>
                <Text style={[styles.text2, { fontFamily: lang.font, }]}>
                    {dietCategory ? dietCategory.description[lang.langName] : lang.whatIsDietDescribe}
                </Text>
                {
                    dietCategory == null &&
                    <>
