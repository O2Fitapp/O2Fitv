...
import { setIsActive, dietStartDate,  setDietMeal, setOldDietFalse } from '../../redux/actions/dietNew'
    ...
    const onSuccess = (res) => {
        if (props.route.params.dietId == 66) {
            ...
            if (snack1.length == 0 || snack2.length == 0 || dinners.length == 0 || eftars.length == 0 || sahars.length == 0) {
                ...
                setTimeout(() => {
                    // navigation.popToTop()
                    navigation.navigate("Drawer", { nextRoute: true })
                }, 300);
            }
                ...
                dispatch(
                    updateTarget(
                        ...
                        () => {
                            ...
                            analytics().logEvent('set_fastingDiet_online')
                        },
                        (err) => {
                            setLoading(false)
                            console.error(err);
                ...
                dispatch(
                    updateTarget(
                        ...
                        () => {
                            ...
                            analytics().logEvent('set_normalDiet_online')
                        },
                        (err) => {
                            setLoading(false)
                            console.error(err);
