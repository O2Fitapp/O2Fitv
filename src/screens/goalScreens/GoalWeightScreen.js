    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <ScrollView style={{ flex: 1 }} contentContainerStyle={{ alignItems: "center" }} showsVerticalScrollIndicator={false}>
                ...
                <View
                    style={{ width: dimensions.WINDOW_WIDTH * 0.9, height: moderateScale(1), backgroundColor: defaultTheme.border, borderRadius: moderateScale(10) }}
                />
                <View style={{ padding: moderateScale(20), alignItems: "center" }}>
                    <Text style={{ fontFamily: lang.font, fontSize: moderateScale(15) }}>{lang.dontForgetToEnterYourWeightEachWeek}</Text>
                    <ConfirmButton
                        style={{ backgroundColor: defaultTheme.white, borderColor: defaultTheme.green, borderWidth: 1, marginVertical: moderateScale(20) }}
                        lang={lang}
                        ...
                        imageStyle={{ tintColor: defaultTheme.green }}
                    />
                </View>
                {
                    lang.langName == "persian" && user.countryId == 128 &&
                    <DietGoalCard
                        lang={lang}
                        diet={diet}
                        dietNew={dietNew}
